# Research trail — Task 38

**Product:** ድረስ (DERES) · Team COD1 · STARK Hackathon 2026  
**Owners:** whole team (Melkamu seeding this pass)  
**Verify:** every major product assumption traces to research, an explicit engineering decision, or a clearly labeled hypothesis.

## Index

| Document | Purpose |
|---|---|
| [problem-evidence.md](./problem-evidence.md) | Bystander-first problem + Ethiopian evidence |
...
- Engineering specification: `docs/Team_COD1_DERES_Full_Engineering_Product_Specification.md`
- Shared contracts agreement: `docs/api/shared-contracts.md`
- Persistence ADR: `docs/decisions/0001-mongodb-persistence.md`
